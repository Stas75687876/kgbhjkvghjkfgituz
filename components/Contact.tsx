...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Beispiel: await fetch('/api/contact', { method: 'POST', body: JSON.stringify(formData) });
  ...
  return (
    <section id="kontakt" className="py-20 bg-black" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Hast du Fragen oder möchtest du ein Projekt besprechen? Wir freuen uns, von dir zu hören!
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-6">Schreib uns eine Nachricht</h3>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="mr-4 mt-1 p-3 bg-gray-800 rounded-full">
                  <Mail className="h-6 w-6 text-purple-500" />
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-white mb-1">E-Mail</h4>
                  <p className="text-gray-300">info@deinewebsite.de</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Musterstraße 123<br />12345 Berlin<br />Deutschland</p>
                </div>
              </div>
            </div>
            
            <div className="mt-10">
              <h4 className="text-lg font-semibold text-white mb-4">Folge uns</h4>
